...
module.exports.actuator = function(navBar, menuLink, actuator) {
    ...
    if (reason == "Periodical"){
        periodicalsel="selected";
    } else {
        periodicalsel="";
    }
    if (reason == "Temporary"){
        temporarysel="selected"
    } else {
        temporarysel="";
    }
	...
	<div class="row" style="margin-top: 30px">
        ...
        <div class="col-10">
            <div class="row" style="margin-left: 10px">
                <div class="col-12"><h3>엑츄에이터 구동</h3></div>
                <div class="col-12"><hr></div>
                <div class="col-11">
                    <h5>최근 구동 시간: ${aTime}</h5>
                        ...
                        <tr><td style="text-align: center;">변경 사유</td>
                            <td style="text-align: center;">
                                <select class="form-control" name="reason">
                                    <option value="Periodical" ${periodicalsel}>정기적</option>
                                    <option value="Temporary" ${temporarysel}>임시적</option>
                                </select>
                            </td></tr>
