...
const DIST_LOW =15.0;
const ok=`<span style="color: black"><i class="far fa-thumbs-up"></i></span>`;
const up=`<span style="color: red"><i class="fas fa-long-arrow-alt-up"></i></span>`;
const down=`<span style="color: blue"><i class="fas fa-long-arrow-alt-down"></i></span>`;
            ...
            <div class="row" style="margin-left: 10px">
                ...
                <div class="col-11">
                    ...
                    <table class="table table-condensed table-hover">
                        ...
                        <tbody>
                        <tr>
                        <td><span style="color: red"><i class="fas fa-thermometer-half"></i></span>&nbsp;&nbsp;온도</td>
                    ...
                    <tr>
                        <td><span style="color: yellow"><i class="far fa-lightbulb"></i></span>&nbsp;&nbsp;조도</td>
                        <td>${CDS_LOW} ~ ${CDS_HIGH}</td>
                        <td>${cds}</td><td>lux</td><td>${cdsSign}</td>
                    </tr>
                    <tr>
                        <td><span style="color: black"><i class="fas fa-ruler-vertical"></i></span>&nbsp;&nbsp;거리</td>
